...
Chrome nutzt die V8 Engine, eine von Google entwickelte JavaScript- und WebAssembly-Laufzeitumgebung, die in C++ implementiert ist.
...
In der Abbildung \ref{fig:AusführungvonWebAssemblyimBrowser} ist dargestellt wie WebAssemblycode in Instruktionen für den spezifischen Browser umgewandelt werden.
...
Die V8 Engine erzeugt den Code für die Funktionen erst wenn diese zum ersten Mal aufgerufen werden.
